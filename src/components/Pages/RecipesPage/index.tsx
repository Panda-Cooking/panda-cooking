...
const RecipesPage = () => {
  ...
  const addComent = async (newComent : any) => {
    ...
    try {
      ...
      const { data } = await api.patch(`/recipes?id=${recipeId}`, [...comments, newComent])
      console.log(data)
    } catch (error) {
      console.log(error)
    }
          ...
          <Main>
            ...
            <section className="thirdRecipeSection">
              ...
              <div className='addComentContainer'>
                <textarea placeholder="Adcionar comentario..." onChange={(e) => saveComment(e.target.value)}></textarea>
